...
public class EntitySubscriber {
    public static final EntityType<DeerEntity> deer = (EntityType<DeerEntity>) EntityType.Builder.of(DeerEntity::new, CREATURE)
            .sized(0.9f, 1.6f).clientTrackingRange(10).build("").setRegistryName(Reference.MODID, "deer");
    public static final EntityType<BoarEntity> boar = (EntityType<BoarEntity>) EntityType.Builder.of(BoarEntity::new, CREATURE)
            .sized(0.9f, 1.5f).clientTrackingRange(10).build("").setRegistryName(Reference.MODID, "boar");
    public static final EntityType<AurochEntity> auroch = (EntityType<AurochEntity>) EntityType.Builder.of(AurochEntity::new, CREATURE)
            .sized(0.9f, 1.5f).clientTrackingRange(10).build("").setRegistryName(Reference.MODID,"auroch");
    public static final EntityType<FowlEntity> fowl = (EntityType<FowlEntity>) EntityType.Builder.of(FowlEntity::new, CREATURE)
            .sized(0.7f, 0.7f).clientTrackingRange(10).build("").setRegistryName(Reference.MODID,"fowl");
    public static final EntityType<MouflonEntity> mouflon = (EntityType<MouflonEntity>) EntityType.Builder.of(MouflonEntity::new, CREATURE)
            .sized(0.9f, 1.5f).clientTrackingRange(10).build("").setRegistryName(Reference.MODID,"mouflon");
    public static final EntityType<MammothEntity> mammoth = (EntityType<MammothEntity>) EntityType.Builder.of(MammothEntity::new, CREATURE)
            .sized(1.9f, 2.0f).clientTrackingRange(10).build("").setRegistryName(Reference.MODID,"mammoth");
    public static final EntityType<SaberToothTigerEntity> saber_tooth_tiger = (EntityType<SaberToothTigerEntity>) EntityType.Builder.of(SaberToothTigerEntity::new, CREATURE)
            .sized(0.9f, 1.1f).clientTrackingRange(8).build("").setRegistryName(Reference.MODID, "saber_tooth_tiger");
    public static final EntityType<WoollyRhinoEntity> woolly_rhino = (EntityType<WoollyRhinoEntity>) EntityType.Builder.of(WoollyRhinoEntity::new, CREATURE)
            .sized(1.7f, 1.4f).clientTrackingRange(10).build("").setRegistryName(Reference.MODID, "woolly_rhino");
    public static final EntityType<TerrorBirdEntity> terror_bird = (EntityType<TerrorBirdEntity>) EntityType.Builder.of(TerrorBirdEntity::new, CREATURE)
            .sized(0.9f, 1.9f).clientTrackingRange(8).build("").setRegistryName(Reference.MODID, "terror_bird");
    public static final EntityType<CoelacanthEntity> coelacanth = (EntityType<CoelacanthEntity>) EntityType.Builder.of(CoelacanthEntity::new, WATER_CREATURE)
            .sized(0.8f, 0.35f).clientTrackingRange(4).build("").setRegistryName(Reference.MODID, "coelacanth");
    ...
    public static void registerEntities(@Nonnull RegistryEvent.Register<EntityType<?>> event) {
        ...
        EntitySpawnPlacementRegistry.register(deer, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::checkAnimalSpawnRules);
        EntitySpawnPlacementRegistry.register(boar, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::checkAnimalSpawnRules);
        EntitySpawnPlacementRegistry.register(auroch, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::checkAnimalSpawnRules);
        EntitySpawnPlacementRegistry.register(fowl, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::checkAnimalSpawnRules);
        EntitySpawnPlacementRegistry.register(mouflon, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::checkAnimalSpawnRules);
        EntitySpawnPlacementRegistry.register(mammoth, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::checkAnimalSpawnRules);
        ...
        EntitySpawnPlacementRegistry.register(woolly_rhino, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::checkAnimalSpawnRules);
