...
public class TanningRackRecipeCategory implements IRecipeCategory<TanningRackRecipe> {
    ...
    public static final RecipeType<TanningRackRecipe> TANNINGRACK_RECIPE_TYPE = new RecipeType<>(UID,TanningRackRecipe.class);
    ...
    TanningRackRecipeCategory(@Nonnull IGuiHelper guiHelper) {
        ...
        icon = guiHelper.createDrawableItemStack(new ItemStack(BlockSubscriber.tanning_rack));
    }
...
//    }
    ...
    @Override
    public RecipeType<TanningRackRecipe> getRecipeType() {
        return TANNINGRACK_RECIPE_TYPE;
    }
    @Nonnull
    @Override
...
//    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull TanningRackRecipe tanningRackRecipe, @Nonnull IFocusGroup focuses) {
//        recipeLayout.getItemStacks().init(0, true, 21, 21);
//        recipeLayout.getItemStacks().set(0, ingredients.getInputs(VanillaTypes.ITEM).get(0));
        builder.addSlot(RecipeIngredientRole.INPUT, 22, 22).addIngredients(tanningRackRecipe.getIngredients().get(0));

//        recipeLayout.getItemStacks().init(1, false, 84, 22);
//        recipeLayout.getItemStacks().set(1, ingredients.getOutputs(VanillaTypes.ITEM).get(0));
        builder.addSlot(RecipeIngredientRole.OUTPUT, 85, 23).addItemStack(tanningRackRecipe.getResultItem(null));
...
//        recipeLayout.getItemStacks().set(2, Collections.singletonList(new ItemStack(BlockSubscriber.tanning_rack)));
        builder.addSlot(RecipeIngredientRole.RENDER_ONLY, 52, 14).addItemStack(new ItemStack(BlockSubscriber.tanning_rack));
