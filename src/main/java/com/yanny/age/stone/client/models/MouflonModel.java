...
public class MouflonModel extends AgeableModel<MouflonEntity> {
    ...
    public MouflonModel() {
        ...
        body.setTextureOffset(8, 6).addBox(-5.0F, -7.0F, 4.0F, 10.0F, 8.0F, 6.0F, 0.0F, false);
        body.setTextureOffset(9, 20).addBox(-4.5F, -6.5F, -2.0F, 9.0F, 7.0F, 6.0F, 0.0F, false);
        body.setTextureOffset(9, 36).addBox(-5.0F, -7.0F, -8.0F, 10.0F, 8.0F, 6.0F, 0.0F, false);

        body4_r1 = new ModelRenderer(this);
        body4_r1.setRotationPoint(0.0F, -4.5F, -8.5F);
        body.addChild(body4_r1);
        setRotationAngle(body4_r1, 0.1309F, 0.0F, 0.0F);
        body4_r1.setTextureOffset(44, 50).addBox(-4.0F, -2.5F, -0.5F, 8.0F, 5.0F, 2.0F, 0.0F, false);

        tail_r1 = new ModelRenderer(this);
        tail_r1.setRotationPoint(0.0F, -3.5F, 11.5F);
        body.addChild(tail_r1);
        setRotationAngle(tail_r1, 0.5672F, 0.0F, 0.0F);
        tail_r1.setTextureOffset(0, 20).addBox(-1.0F, -1.5F, -1.5F, 2.0F, 3.0F, 1.0F, 0.0F, false);

        head = new ModelRenderer(this);
        head.setRotationPoint(0.0F, 7.0F, -8.0F);
        head.setTextureOffset(40, 0).addBox(-3.0F, -7.0F, -5.0F, 6.0F, 5.0F, 6.0F, 0.0F, false);
        head.setTextureOffset(43, 12).addBox(-2.0F, -5.5F, -8.0F, 4.0F, 3.0F, 3.0F, 0.0F, false);

        neck_r1 = new ModelRenderer(this);
        neck_r1.setRotationPoint(0.0F, -1.0F, 0.5F);
        head.addChild(neck_r1);
        setRotationAngle(neck_r1, 0.3491F, 0.0F, 0.0F);
        neck_r1.setTextureOffset(28, 51).addBox(-2.5F, -3.0F, -2.5F, 5.0F, 6.0F, 4.0F, 0.0F, false);

        ear2_r1 = new ModelRenderer(this);
        ear2_r1.setRotationPoint(4.0F, -6.5F, -2.5F);
        head.addChild(ear2_r1);
        setRotationAngle(ear2_r1, 0.0F, 0.0F, 0.2182F);
        ear2_r1.setTextureOffset(55, 20).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);

        ear1_r1 = new ModelRenderer(this);
        ear1_r1.setRotationPoint(-4.0F, -6.5F, -2.5F);
        head.addChild(ear1_r1);
        setRotationAngle(ear1_r1, 0.0F, 0.0F, -0.2182F);
        ear1_r1.setTextureOffset(55, 20).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);

        head3_r1 = new ModelRenderer(this);
        head3_r1.setRotationPoint(0.0F, -6.0F, -6.5F);
        head.addChild(head3_r1);
        setRotationAngle(head3_r1, 0.2618F, 0.0F, 0.0F);
        head3_r1.setTextureOffset(44, 19).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 5.0F, 0.0F, false);

        horn = new ModelRenderer(this);
        horn.setRotationPoint(0.0F, -3.0F, -2.0F);
        head.addChild(horn);


        horn3_r1 = new ModelRenderer(this);
        horn3_r1.setRotationPoint(0.0F, -1.5F, 1.0F);
        horn.addChild(horn3_r1);
        setRotationAngle(horn3_r1, -0.6109F, 0.2269F, -0.1047F);
        horn3_r1.setTextureOffset(10, 0).addBox(1.0F, -4.5F, -2.0F, 2.0F, 3.0F, 1.0F, 0.0F, false);

        horn4_r1 = new ModelRenderer(this);
        horn4_r1.setRotationPoint(2.0F, -5.5F, 2.0F);
        horn.addChild(horn4_r1);
        setRotationAngle(horn4_r1, -0.5236F, 0.3665F, 0.3578F);
        horn4_r1.setTextureOffset(10, 0).addBox(0.0F, -3.5F, -1.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);

        horn2_r1 = new ModelRenderer(this);
        horn2_r1.setRotationPoint(-2.0F, -7.5F, 1.0F);
        horn.addChild(horn2_r1);
        setRotationAngle(horn2_r1, -0.5236F, -0.4363F, -0.3752F);
        horn2_r1.setTextureOffset(10, 0).addBox(-1.0F, -2.5F, 1.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);

        horn1_r1 = new ModelRenderer(this);
        horn1_r1.setRotationPoint(0.0F, -1.5F, 1.0F);
        horn.addChild(horn1_r1);
        setRotationAngle(horn1_r1, -0.6109F, -0.2269F, 0.1047F);
        horn1_r1.setTextureOffset(10, 0).addBox(-3.0F, -4.5F, -2.0F, 2.0F, 3.0F, 1.0F, 0.0F, false);

        feet1 = new ModelRenderer(this);
        feet1.setRotationPoint(2.0F, 14.0F, -5.0F);
        feet1.setTextureOffset(0, 0).addBox(0.0F, -1.0F, 0.0F, 2.0F, 11.0F, 2.0F, 0.0F, false);

        feet3 = new ModelRenderer(this);
        feet3.setRotationPoint(-2.0F, 14.0F, 6.0F);
        feet3.setTextureOffset(56, 40).addBox(-2.0F, 3.0F, 2.5F, 2.0F, 7.0F, 2.0F, 0.0F, false);

        feet3_2_r1 = new ModelRenderer(this);
        feet3_2_r1.setRotationPoint(0.0F, 3.0F, 3.0F);
        feet3.addChild(feet3_2_r1);
        setRotationAngle(feet3_2_r1, 0.2618F, 0.0F, 0.0F);
        feet3_2_r1.setTextureOffset(52, 29).addBox(-2.5F, -4.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.0F, false);

        feet4 = new ModelRenderer(this);
        feet4.setRotationPoint(-2.0F, 14.0F, -5.0F);
        feet4.setTextureOffset(0, 0).addBox(-2.0F, -1.0F, 0.0F, 2.0F, 11.0F, 2.0F, 0.0F, false);

        feet2 = new ModelRenderer(this);
        feet2.setRotationPoint(4.0F, 14.0F, 6.0F);
        feet2.setTextureOffset(56, 40).addBox(-2.0F, 3.0F, 2.5F, 2.0F, 7.0F, 2.0F, 0.0F, false);

        feet3_2_r2 = new ModelRenderer(this);
        feet3_2_r2.setRotationPoint(0.0F, 3.0F, 3.0F);
        feet2.addChild(feet3_2_r2);
        setRotationAngle(feet3_2_r2, 0.2618F, 0.0F, 0.0F);
        feet3_2_r2.setTextureOffset(52, 29).addBox(-2.5F, -4.0F, -1.5F, 3.0F, 6.0F, 3.0F, 0.0F, false);
    }
